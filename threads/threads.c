...
int main(int c, char* arbv[]) {
    ...
    // (done) fix the parameters in this invocation // HARD
    ...
    // // (done) fix parameters to this invocation // PITFALL
    ...
    sel4utils_arch_init_local_context((void*)new_thread,
                                    ...
                                    (void*)inspect, (void*)&global_int, (void*)3, // (done) Resolving a fault
